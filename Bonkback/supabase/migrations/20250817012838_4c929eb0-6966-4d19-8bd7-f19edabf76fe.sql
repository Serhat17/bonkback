...
-- First, let's check if there are any functions referencing the wrong column name
-- and fix the handle_new_user function to not cause conflicts

-- Drop and recreate handle_new_user to ensure it doesn't reference solana_key_vault incorrectly
