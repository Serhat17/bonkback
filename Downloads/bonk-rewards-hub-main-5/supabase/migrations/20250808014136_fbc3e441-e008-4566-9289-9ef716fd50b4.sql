-- Production improvements for account_deletion_requests table
...
-- 2) One pending request per user (prevents duplicates)
...
-- 4) RLS: let users update/cancel ONLY their own *pending* request
...
-- 5) Helper function for requesting account deletion
...
-- 6) Helper function for cancelling account deletion
